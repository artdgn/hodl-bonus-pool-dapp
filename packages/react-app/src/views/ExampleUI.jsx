...
export default function ExampleUI(
  {purpose, setPurposeEvents, address, mainnetProvider, 
    userProvider, localProvider, yourLocalBalance, price, tx, 
    readContracts, writeContracts, contractName}) {
      ...
      */}
      <div style={{border:"1px solid #cccccc", padding:16, width:400, margin:"auto",marginTop:64}}>
        ...
        <div style={{margin:8}}>
          <Button onClick={()=>{
            /* look how you call setPurpose on your contract: */
            tx( writeContracts[contractName].setPurpose("🍻 Cheers") )
        ...
        <div style={{margin:8}}>
          <Button onClick={()=>{
            ...
            */
            tx({
              to: writeContracts[contractName].address,
        ...
        <div style={{margin:8}}>
          <Button onClick={()=>{
            ...
            tx( writeContracts[contractName].setPurpose("💵 Paying for this one!",{
              value: parseEther("0.001")
            }))
        ...
        <div style={{margin:8}}>
          <Button onClick={()=>{
            ...
            tx({
              to: writeContracts[contractName].address,
              value: parseEther("0.001"),
              data: writeContracts[contractName].interface.encodeFunctionData("setPurpose(string)",["🤓 Whoa so 1337!"])
            });
            /* this should throw an error about "no fallback nor receive function" until you add it */
